...
def apoint():
    ...
    frame.pack()
    l1=Label(root2,text="Your ID no.")
    l1.place(x=10,y=130)
...
def ser_avail():
    ...
    l5=Label(root5,text='To avail any of these please contact on our no.:- 9389841227')
    l5.place(x=20,y=240)
...
def mod_sub():
    ...
    frame.pack()
    l1=Label(root7,text="Your ID no.")
    l1.place(x=10,y=130)
...
def modify():
    ...
    if len(a)==0:
      ...
      L2.place(x=50,y=360)
      print("Your data is modified successfully")
